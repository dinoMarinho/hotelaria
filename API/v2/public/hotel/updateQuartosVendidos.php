<?php
    ...
    $result = $Hotel->updateQuartosVendidos($id,$value);

    $Log = new Log($conn);

    if (isset($result['code']) && $result['code'] == 1 ){
        $msg = 'Atualizou a quantidade de quartos vendidos do hotel com ID: '. $id;
    }else{
        $msg = 'Tentou atualizar a quantidade de quartos vendidos do hotel com ID:'. $id;
    }   
